...
public enum Difficulty {
	EASY("easy", .5f, .5f, 1.5f, .5f, false, 25, 3, 30), 
	NORMAL("normal", 1, 1, 1, 1, false, 25, 7, 20), 
	HARD("hard", 3, 3, .5f, 1.5f, true, 25, 12, 15), 
	NIGHTMARE("nightmare", 6, 5, .25f, 2.5f, true, 15, 100000, 10);
	...
	private Difficulty(String difficultyName, float mobHealthModifier, float mobStrengthModifier, float mobSpawnModifier, float shopCostsModifier, boolean mobRegeneration, int regenerationInterval, int allowedMobDensity, int coinLifespan) {
